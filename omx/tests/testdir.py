...
class Removal(unittest.TestCase):
	...
	def test_remove_intermediate_and_children(self):
		...
		self.assertRaises(KeyError, self.dir.get, '/inter/mediate/bar')
		self.assertRaises(KeyError, self.dir.get, '/inter/mediate/baz')
		self.assertRaises(KeyError, self.dir.get, '/inter/mediate/baz/zz')
